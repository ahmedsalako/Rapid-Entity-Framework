...
namespace PersistentManager.Linq
{
    public abstract class ExpressionVisitor
    {
        ...
        protected static object GetMethodAssignment( Expression expression )
        {
            if ( ExpressionReader.GetRootExpression( expression ) is ParameterExpression )
                return null;

            object value = expression.NodeType == ExpressionType.Constant ? ( ( ConstantExpression ) expression ).Value

...
namespace consist.RapidEntity
{
	...
	/// </remarks>
	public partial class RapidEntityToolboxHelper : RapidEntityToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new RapidEntityToolboxHelper.
		/// </summary>
		public RapidEntityToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class RapidEntityToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify RapidEntity toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "RapidEntity.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new RapidEntityToolboxHelperBase.
		/// </summary>
		protected RapidEntityToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::consist.RapidEntity.RapidEntityDomainModel.SingletonResourceManager.GetString("Class DiagramsToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "consist.RapidEntity.DslPackage.ModelClassToolboxItem":
					// Add ModelClass shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"consist.RapidEntity.DslPackage.ModelClassToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"consist.RapidEntity.DslPackage.Class DiagramsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						...
						CreateElementToolPrototype(store, global::consist.RapidEntity.ModelClass.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "consist.RapidEntity.DslPackage.BidirectionalAssociationToolboxItem":

					// Add BidirectionalAssociation connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"consist.RapidEntity.DslPackage.BidirectionalAssociationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "consist.RapidEntity.DslPackage.AggregationToolboxItem":

					// Add Aggregation connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"consist.RapidEntity.DslPackage.AggregationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "consist.RapidEntity.DslPackage.GeneralizationToolboxItem":

					// Add Generalization connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"consist.RapidEntity.DslPackage.GeneralizationToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "consist.RapidEntity.DslPackage.CommentToolboxItem":
					// Add Comment shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"consist.RapidEntity.DslPackage.CommentToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::consist.RapidEntity.Comment.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "consist.RapidEntity.DslPackage.CommentsReferenceTypesToolboxItem":

					// Add CommentsReferenceTypes connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"consist.RapidEntity.DslPackage.CommentsReferenceTypesToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::consist.RapidEntity.RapidEntityDomainModel));

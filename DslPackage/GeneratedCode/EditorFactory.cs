...
namespace consist.RapidEntity.DslPackage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.RapidEntityEditorFactoryId)]
	internal partial class RapidEntityEditorFactory : RapidEntityEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new RapidEntityEditorFactory.
		/// </summary>
		public RapidEntityEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RapidEntityEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected RapidEntityEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new RapidEntityDocData(this.ServiceProvider, typeof(RapidEntityEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new RapidEntityDocView(docData, this.ServiceProvider);
		}
	}
}

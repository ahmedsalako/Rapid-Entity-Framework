...
namespace consist.RapidEntity
{
	...
	/// </summary>
	public static partial class OneToOneBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::consist.RapidEntity.ModelClass)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::consist.RapidEntity.ModelClass)
				{
					if (candidateTarget is global::consist.RapidEntity.ModelClass)
					{
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::consist.RapidEntity.ModelClass)
				{
					if (target is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.ModelClass sourceAccepted = (global::consist.RapidEntity.ModelClass)source;
						global::consist.RapidEntity.ModelClass targetAccepted = (global::consist.RapidEntity.ModelClass)target;
						DslModeling::ElementLink result = new global::consist.RapidEntity.OneToOne(sourceAccepted, targetAccepted);
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class OneToManyBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::consist.RapidEntity.ModelClass)
				{
					if (target is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.ModelClass sourceAccepted = (global::consist.RapidEntity.ModelClass)source;
						global::consist.RapidEntity.ModelClass targetAccepted = (global::consist.RapidEntity.ModelClass)target;
						DslModeling::ElementLink result = new global::consist.RapidEntity.OneToMany(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::consist.RapidEntity.ModelClass)
				{
					if (candidateTarget is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.ModelClass sourceModelClass = (global::consist.RapidEntity.ModelClass)candidateSource;
						global::consist.RapidEntity.ModelClass targetModelClass = (global::consist.RapidEntity.ModelClass)candidateTarget;
						if(targetModelClass == null || global::consist.RapidEntity.Generalization.GetLinkToSuperclass(targetModelClass) != null) return false;
						if(targetModelClass == null || sourceModelClass == null || global::consist.RapidEntity.Generalization.GetLinks(sourceModelClass, targetModelClass).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::consist.RapidEntity.ModelClass)
				{
					if (target is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.ModelClass sourceAccepted = (global::consist.RapidEntity.ModelClass)source;
						global::consist.RapidEntity.ModelClass targetAccepted = (global::consist.RapidEntity.ModelClass)target;
						DslModeling::ElementLink result = new global::consist.RapidEntity.Generalization(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	public static partial class CommentReferencesSubjectsBuilder
	{
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::consist.RapidEntity.Comment)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptTarget(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::consist.RapidEntity.ModelType)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::consist.RapidEntity.Comment)
				{
					if (candidateTarget is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.Comment sourceComment = (global::consist.RapidEntity.Comment)candidateSource;
						global::consist.RapidEntity.ModelClass targetModelClass = (global::consist.RapidEntity.ModelClass)candidateTarget;
						if(targetModelClass == null || sourceComment == null || global::consist.RapidEntity.CommentReferencesSubjects.GetLinks(sourceComment, targetModelClass).Count > 0) return false;
						return true;
					}
					else if (candidateTarget is global::consist.RapidEntity.ModelType)
					{
						global::consist.RapidEntity.Comment sourceComment = (global::consist.RapidEntity.Comment)candidateSource;
						global::consist.RapidEntity.ModelType targetModelType = (global::consist.RapidEntity.ModelType)candidateTarget;
						if(targetModelType == null || sourceComment == null || global::consist.RapidEntity.CommentReferencesSubjects.GetLinks(sourceComment, targetModelType).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::consist.RapidEntity.Comment)
				{
					if (target is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.Comment sourceAccepted = (global::consist.RapidEntity.Comment)source;
						global::consist.RapidEntity.ModelClass targetAccepted = (global::consist.RapidEntity.ModelClass)target;
						DslModeling::ElementLink result = new global::consist.RapidEntity.CommentReferencesSubjects(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
					...
					else if (target is global::consist.RapidEntity.ModelType)
					{
						global::consist.RapidEntity.Comment sourceAccepted = (global::consist.RapidEntity.Comment)source;
						global::consist.RapidEntity.ModelType targetAccepted = (global::consist.RapidEntity.ModelType)target;
						DslModeling::ElementLink result = new global::consist.RapidEntity.CommentReferencesSubjects(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class ManyToManyBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			else // Check combinations
			{
				if (candidateSource is global::consist.RapidEntity.ModelClass)
				{
					if (candidateTarget is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.ModelClass sourceModelClass = (global::consist.RapidEntity.ModelClass)candidateSource;
						global::consist.RapidEntity.ModelClass targetModelClass = (global::consist.RapidEntity.ModelClass)candidateTarget;
						if(targetModelClass == null || sourceModelClass == null || global::consist.RapidEntity.ManyToMany.GetLinks(sourceModelClass, targetModelClass).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::consist.RapidEntity.ModelClass)
				{
					if (target is global::consist.RapidEntity.ModelClass)
					{
						global::consist.RapidEntity.ModelClass sourceAccepted = (global::consist.RapidEntity.ModelClass)source;
						global::consist.RapidEntity.ModelClass targetAccepted = (global::consist.RapidEntity.ModelClass)target;
						DslModeling::ElementLink result = new global::consist.RapidEntity.ManyToMany(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	internal partial class BidirectionalAssociationConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class BidirectionalAssociationConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder OneToOneBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return OneToOneBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return OneToOneBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				OneToOneBuilder.Connect(sourceElement, targetElement);
			}
		}
	...
	internal partial class AggregationConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class AggregationConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder OneToManyBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				bool canConnect = true;
				...
				{				
					if(targetShapeElement == null)
					{
						return OneToManyBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return OneToManyBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				DslModeling::ModelElement targetElement = targetShapeElement.ModelElement;
				if(targetElement == null) targetElement = targetShapeElement;
				OneToManyBuilder.Connect(sourceElement, targetElement);
			}
		}

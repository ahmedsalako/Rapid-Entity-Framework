...
namespace consist.RapidEntity.DslPackage
{
	...
	{
		/// <summary>
		/// Constructs a new RapidEntityCommandSet.
		/// </summary>
		public RapidEntityCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class RapidEntityCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new RapidEntityCommandSetBase.
		/// </summary>
		protected RapidEntityCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewRapidEntityExplorerCommand,
				typeof(RapidEntityEditorFactory).GUID);
		...
		{
			RapidEntityExplorerToolWindow explorer = this.RapidEntityExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentRapidEntityDocData != null && this.CurrentRapidEntityDocData.Store != null)
			{
				this.CurrentRapidEntityDocData.ValidationController.Validate(this.CurrentRapidEntityDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentRapidEntityDocData != null && this.CurrentRapidEntityDocData.Store != null)
			{
				...
				this.CurrentRapidEntityDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected RapidEntityDocData CurrentRapidEntityDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as RapidEntityDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected RapidEntityDocView CurrentRapidEntityDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as RapidEntityDocView;
			}
		}
		...
		/// </summary>
		protected RapidEntityExplorerToolWindow RapidEntityExplorerToolWindow
		{
			get
			{
				RapidEntityExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(RapidEntityExplorerToolWindow), true) as RapidEntityExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				RapidEntityExplorerToolWindow explorerWindow = this.RapidEntityExplorerToolWindow;

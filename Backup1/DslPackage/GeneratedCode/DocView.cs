...
namespace consist.RapidEntity.DslPackage
{
	...
	/// </summary>
	internal partial class RapidEntityDocView : RapidEntityDocViewBase
	{
		/// <summary>
		/// Constructs a new RapidEntityDocView.
		/// </summary>
		public RapidEntityDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class RapidEntityDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new RapidEntityDocView.
		/// </summary>
		protected RapidEntityDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			RapidEntityDocDataBase docData = this.DocData as RapidEntityDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for RapidEntityDocViewBase should be an RapidEntityDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::consist.RapidEntity.ClassDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::consist.RapidEntity.ClassDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::consist.RapidEntity.RapidEntityToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::consist.RapidEntity.RapidEntityToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.RapidEntityDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::consist.RapidEntity.RapidEntityHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::consist.RapidEntity.RapidEntityHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::consist.RapidEntity.RapidEntityHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);

...
namespace consist.RapidEntity
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides RapidEntity files
	/// The implementation is done in RapidEntityDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class RapidEntityDirectiveProcessor : RapidEntityDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public RapidEntityDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides RapidEntity files
	/// </summary>
	public class RapidEntityDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string RapidEntityDirectiveProcessorName = "RapidEntityDirectiveProcessor";
		...
		/// </summary>
		private const string supportedDirectiveName = "RapidEntity";
		...
		/// Constructor
		/// </summary>
		public RapidEntityDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return RapidEntityDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::consist.RapidEntity.ModelRoot));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::consist.RapidEntity.ModelRoot));
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"consist.RapidEntity.RapidEntityDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("RapidEntityDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("consist.RapidEntity");

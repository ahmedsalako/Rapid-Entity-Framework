...
namespace consist.RapidEntity
{
	...
	/// </remarks>
	public partial class RapidEntityHelpKeywordHelper : RapidEntityHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new RapidEntityHelpKeywordHelper.
		/// </summary>
		protected RapidEntityHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the RapidEntityHelpKeywordHelper.
		/// </summary>
		public static RapidEntityHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class RapidEntityHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new RapidEntityHelpKeywordHelperBase.
		/// </summary>
		protected RapidEntityHelpKeywordHelperBase()
			: base() { }
